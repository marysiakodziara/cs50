...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            {
                copy[i][j].rgbtRed = round((image[i - 1][j - 1].rgbtRed + image[i - 1][j].rgbtRed + image[i - 1][j + 1].rgbtRed + image[i][j -
                                            1].rgbtRed + image[i][j].rgbtRed + image[i][j + 1].rgbtRed + image[i + 1][j - 1].rgbtRed + image[i + 1][j].rgbtRed + image[i + 1]
                                            [j
                                             + 1].rgbtRed) / 9.0);
                copy[i][j].rgbtGreen = round((image[i - 1][j - 1].rgbtGreen + image[i - 1][j].rgbtGreen + image[i - 1][j + 1].rgbtGreen + image[i][j
    ...
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            else if (i == 0 && j == (width - 1))
            {
                ...
                gxb = ((-2) * image[i][j - 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 0 * image[i + 1][j].rgbtBlue +
                       (-1) * image[i + 1][j - 1].rgbtBlue);
                gyb = (0 * image[i][j - 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 2 * image[i + 1][j].rgbtBlue + image[i + 1][j - 1].rgbtBlue);
            }
            else if (i == 0)
            {
                gx = ((-2) * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed + 2 * image[i][j + 1].rgbtRed +
                      (-1) * image[i + 1][j - 1].rgbtRed + 0 * image[i + 1][j].rgbtRed + image[i + 1][j + 1].rgbtRed);
                gy = (0 * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed + 0 * image[i][j + 1].rgbtRed + image[i + 1][j - 1].rgbtRed + 2 *
                      image[i + 1][j].rgbtRed + image[i + 1][j + 1].rgbtRed);
                gxg = ((-2) * image[i][j - 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 2 * image[i][j + 1].rgbtGreen +
                       (-1) * image[i + 1][j - 1].rgbtGreen + 0 * image[i + 1][j].rgbtGreen + image[i + 1][j + 1].rgbtGreen);
                gyg = (0 * image[i][j - 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 0 * image[i][j + 1].rgbtGreen + image[i + 1][j - 1].rgbtGreen + 2
                       * image[i + 1][j].rgbtGreen + image[i + 1][j + 1].rgbtGreen);
                gxb = ((-2) * image[i][j - 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 2 * image[i][j + 1].rgbtBlue +
                       (-1) * image[i + 1][j - 1].rgbtBlue + 0 * image[i + 1][j].rgbtBlue + image[i + 1][j + 1].rgbtBlue);
                gyb = (0 * image[i][j - 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 0 * image[i][j + 1].rgbtBlue + image[i + 1][j - 1].rgbtBlue + 2 *
            ...
            else if (j == (width - 1) && i == (height - 1))
            {
                ...
                gxg = ((-1) * image[i - 1][j - 1].rgbtGreen + 0 * image[i - 1][j].rgbtGreen + (-2) * image[i][j - 1].rgbtGreen + 0 *
                       image[i][j].rgbtGreen);
                gyg = ((-1) * image[i - 1][j - 1].rgbtGreen + (-2) * image[i - 1][j].rgbtGreen + 0 * image[i][j - 1].rgbtGreen + 0 *
                       image[i][j].rgbtGreen);
                gxb = ((-1) * image[i - 1][j - 1].rgbtBlue + 0 * image[i - 1][j].rgbtBlue + (-2) * image[i][j - 1].rgbtBlue + 0 *
                       image[i][j].rgbtBlue);
                gyb = ((-1) * image[i - 1][j - 1].rgbtBlue + (-2) * image[i - 1][j].rgbtBlue + 0 * image[i][j - 1].rgbtBlue + 0 *
                       image[i][j].rgbtBlue);
            }
            else if (j == (width - 1))
            {
                gx = ((-1) * image[i - 1][j - 1].rgbtRed + 0 * image[i - 1][j].rgbtRed + (-2)  * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed
                      + (-1) * image[i + 1][j - 1].rgbtRed + 0 * image[i + 1][j].rgbtRed);
                gy = ((-1) * image[i - 1][j - 1].rgbtRed + (-2) * image[i - 1][j].rgbtRed + 0 * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed +
                      image[i + 1][j - 1].rgbtRed + 2 * image[i + 1][j].rgbtRed);
                gxg = ((-1) * image[i - 1][j - 1].rgbtGreen + 0 * image[i - 1][j].rgbtGreen + (-2) * image[i][j - 1].rgbtGreen + 0 *
                       image[i][j].rgbtGreen + (-1) * image[i + 1][j - 1].rgbtGreen + 0 * image[i + 1][j].rgbtGreen);
                gyg = ((-1) * image[i - 1][j - 1].rgbtGreen + (-2) * image[i - 1][j].rgbtGreen + 0 * image[i][j - 1].rgbtGreen + 0 *
                       image[i][j].rgbtGreen + image[i + 1][j - 1].rgbtGreen + 2 * image[i + 1][j].rgbtGreen);
                gxb = ((-1) * image[i - 1][j - 1].rgbtBlue + 0 * image[i - 1][j].rgbtBlue + (-2) * image[i][j - 1].rgbtBlue + 0 *
                       image[i][j].rgbtBlue + (-1) * image[i + 1][j - 1].rgbtBlue + 0 * image[i + 1][j].rgbtBlue);
                gyb = ((-1) * image[i - 1][j - 1].rgbtBlue + (-2) * image[i - 1][j].rgbtBlue + 0 * image[i][j - 1].rgbtBlue + 0 *
                       image[i][j].rgbtBlue + image[i + 1][j - 1].rgbtBlue + 2 * image[i + 1][j].rgbtBlue);
            }
            else if (i == (height - 1) && j == 0)
            {
                ...
                gyg = ((-2) * image[i - 1][j].rgbtGreen + (-1) * image[i - 1][j + 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 0 * image[i][j +
                        1].rgbtGreen);
                gxb = (0 * image[i - 1][j].rgbtBlue + image[i - 1][j + 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 2 * image[i][j + 1].rgbtBlue);
                gyb = ((-2) * image[i - 1][j].rgbtBlue + (-1) * image[i - 1][j + 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 0 * image[i][j +
                        1].rgbtBlue);
            }
            else if (i == (height - 1))
            {
                gx = ((-1) * image[i - 1][j - 1].rgbtRed + 0 * image[i - 1][j].rgbtRed + image[i - 1][j + 1].rgbtRed +
                      (-2) * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed + 2 * image[i][j + 1].rgbtRed);
                gy = ((-1) * image[i - 1][j - 1].rgbtRed + (-2) * image[i - 1][j].rgbtRed + (-1) * image[i - 1][j + 1].rgbtRed + 0 * image[i][j -
                        1].rgbtRed + 0 * image[i][j].rgbtRed + 0 * image[i][j + 1].rgbtRed);
                gxg = ((-1) * image[i - 1][j - 1].rgbtGreen + 0 * image[i - 1][j].rgbtGreen + image[i - 1][j + 1].rgbtGreen +
                       (-2) * image[i][j - 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 2 * image[i][j + 1].rgbtGreen);
                gyg = ((-1) * image[i - 1][j - 1].rgbtGreen + (-2) * image[i - 1][j].rgbtGreen + (-1) * image[i - 1][j + 1].rgbtGreen + 0 *
                       image[i][j - 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 0 * image[i][j + 1].rgbtGreen);;
                ...
                gyb = ((-1) * image[i - 1][j - 1].rgbtBlue + (-2) * image[i - 1][j].rgbtBlue + (-1) * image[i - 1][j + 1].rgbtBlue + 0 * image[i][j
                        - 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 0 * image[i][j + 1].rgbtBlue);
            }
            else if (j == 0)
            {
                gx = (0 * image[i - 1][j].rgbtRed + image[i - 1][j + 1].rgbtRed + 0 * image[i][j].rgbtRed + 2 * image[i][j + 1].rgbtRed + 0 *
                      image[i + 1][j].rgbtRed + image[i + 1][j + 1].rgbtRed);
                gy = ((-2) * image[i - 1][j].rgbtRed + (-1) * image[i - 1][j + 1].rgbtRed + 0 * image[i][j].rgbtRed + 0 * image[i][j + 1].rgbtRed +
                      2 * image[i + 1][j].rgbtRed + image[i + 1][j + 1].rgbtRed);
                gxg = (0 * image[i - 1][j].rgbtGreen + image[i - 1][j + 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 2 * image[i][j + 1].rgbtGreen + 0
                       * image[i + 1][j].rgbtGreen + image[i + 1][j + 1].rgbtGreen);
                gyg = ((-2) * image[i - 1][j].rgbtGreen + (-1) * image[i - 1][j + 1].rgbtGreen + 0 * image[i][j].rgbtGreen + 0 * image[i][j +
                        1].rgbtGreen + 2 * image[i + 1][j].rgbtGreen + image[i + 1][j + 1].rgbtGreen);
                gxb = (0 * image[i - 1][j].rgbtBlue + image[i - 1][j + 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 2 * image[i][j + 1].rgbtBlue + 0 *
                       image[i + 1][j].rgbtBlue + image[i + 1][j + 1].rgbtBlue);
                gyb = ((-2) * image[i - 1][j].rgbtBlue + (-1) * image[i - 1][j + 1].rgbtBlue + 0 * image[i][j].rgbtBlue + 0 * image[i][j +
            ...
            {
                gx = ((-1) * image[i - 1][j - 1].rgbtRed + 0 * image[i - 1][j].rgbtRed + image[i - 1][j + 1].rgbtRed +
                      (-2) * image[i][j - 1].rgbtRed + 0 * image[i][j].rgbtRed + 2 * image[i][j + 1].rgbtRed + (-1) * image[i + 1][j - 1].rgbtRed + 0 *
                      image[i + 1][j].rgbtRed + image[i + 1][j + 1].rgbtRed);
                gy = ((-1) * image[i - 1][j - 1].rgbtRed + (-2) * image[i - 1][j].rgbtRed + (-1) * image[i - 1][j + 1].rgbtRed + 0 * image[i][j -
                        1].rgbtRed + 0 * image[i][j].rgbtRed + 0 * image[i][j + 1].rgbtRed + image[i + 1][j - 1].rgbtRed + 2 * image[i + 1][j].rgbtRed +
